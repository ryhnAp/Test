...
public class PurchaseList {
  ...
  public void testPurchaseList() throws Exception {
    ...
    driver.get("http://localhost:8080/swagger-ui/index.html#/");
    driver.findElement(By.cssSelector("#operations-buy-list-controller-purchaseBuyList > div.opblock-summary.opblock-summary-post > button.opblock-summary-control > svg.arrow")).click();
    ...
    driver.findElement(By.xpath("//div[@id='operations-buy-list-controller-purchaseBuyList']/div[2]/div/div[2]/button[2]")).click();
    driver.findElement(By.xpath("//div[@id='operations-buy-list-controller-purchaseBuyList']/div[2]/div/div/div/div[2]/button[2]")).click();
    // ERROR: Caught exception [ERROR: Unsupported command [doubleClick | xpath=//div[@id='operations-buy-list-controller-purchaseBuyList']/div[2]/div/div/div/div[2]/button | ]]
    driver.findElement(By.xpath("//div[@id='operations-buy-list-controller-purchaseBuyList']/div[2]/div/div/div/div[2]/button")).click();
    driver.findElement(By.cssSelector("#operations-buy-list-controller-purchaseBuyList > div.opblock-summary.opblock-summary-post > button.opblock-summary-control > svg.arrow")).click();
    driver.get("http://localhost:8080/swagger-ui/index.html#/");
    driver.findElement(By.cssSelector("#operations-buy-list-controller-getPurchasedList > div.opblock-summary.opblock-summary-post > button.opblock-summary-control > svg.arrow")).click();
    ...
    driver.findElement(By.xpath("//div[@id='operations-buy-list-controller-getPurchasedList']/div[2]/div/div[2]/button[2]")).click();
    driver.findElement(By.xpath("//div[@id='operations-buy-list-controller-getPurchasedList']/div[2]/div/div/div/div[2]/button[2]")).click();
    driver.findElement(By.xpath("//div[@id='operations-buy-list-controller-getPurchasedList']/div[2]/div/div/div/div[2]/button")).click();
    driver.findElement(By.cssSelector("#operations-buy-list-controller-getPurchasedList > div.opblock-summary.opblock-summary-post > button.opblock-summary-control > svg.arrow")).click();
  }
